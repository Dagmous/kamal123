...
\033[1;32m  • \033[1;37m Version    :-  16.4""")
os.system('clear')
...
def rd1(ids,passlist):
    try:
        ...
        for pas in passlist:
                ...
                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/61.0.0.6906;FBPN/com.facebook.lite;FBLC/en_US;FBBV/159117767;FBMF/huawei;FBDV/P30-Lite;KOT49H;FBSV/9.0.0;FBCA/arm64-v8a:arm64;FBDM/{density=2.0,width=1080,height=1920};FB_FW/1;FBRV/30296432;]"
